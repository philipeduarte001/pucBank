...
<body>
    <div class="div-bloco">
        ...
        <div class="div-ctd-cen">
            <font color="black" size="5px">Faça seu login</font><br><br>
            <form action="?go=login" method="post">
                <div>
                    <input class="input-text-login" type="text" id="cpf" name="cpf" placeholder="CPF"  />
                </div>
                <div>
                    <input class="input-text-login" type="password" id="password" name="password" placeholder="Senha" />
                </div>
